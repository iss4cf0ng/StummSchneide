...
objcopy -O binary -j .text -j .data shellcode.exe shellcode.bin
i686-w64-mingw32-g++ -o loader.exe loader.cpp -lsetupapi -static
i686-w64-mingw32-g++ -shared -o payload.dll payload.cpp -lws2_32 -lsecur32 -lcrypt32 -lgdiplus -lgdi32 -lole32 -lsetupapi -lvfw32 -Wl,--subsystem,windows
